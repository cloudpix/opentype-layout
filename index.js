...
module.exports = function (font, text, opt) {
	 ...
	 * 	- 2 Lines. Line 1 start at 0 and end at 29. Line 2 start at 30 and end at 40.
	 * 	- Old version has j < end.
	 * 	- So with a start of 0 -> end at < 29 means the loop will skip over the 29th index and then continue at the 30th idx
	 * 	- However, when laying out the last line, we don't want to go out of range of the string (<= length = .notdef glyph being set)
	 */
